//! Gas-related value objects: `Wei` and `Gwei` newtypes used across the
//! domain (fees, balances, oracle tiers on the Home screen).
...
impl Wei {
    ...
    /// right behaviour for display purposes; a separate conversion should
    /// be added if we ever need rounding or exact decimal arithmetic.
    #[must_use]
